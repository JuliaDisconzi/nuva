...
export default function Podologia() {
    ...
    return (
            ...
            >
                ...
                <div className="flex-1 text-left">
                    <p className="text-black text-2xl leading-relaxed">
                        ...
                        Nosso serviço de Podologia é voltado para promover saúde, conforto e bem-estar, tratando e prevenindo alterações que podem causar dor, desconforto ou dificuldades no dia a dia.

                        Durante o atendimento, realizamos uma avaliação completa dos pés, observando a pele, unhas e possíveis alterações que merecem atenção. O tratamento é feito com todo o cuidado, utilizando materiais esterilizados e técnicas seguras, garantindo uma experiência tranquila e acolhedora.
                    </p>
                </div>
        ...
        "
            ...
            <a
                href="https://wa.me/554896380880?text=Olá,%20quero%20agendar%20meu%20horário!"
                target="_blank"
