            ...
            >
                ...
                <div className="flex-1 text-left">
                    <p className="text-black text-2xl leading-relaxed">
                        A estética vai além da beleza: é um cuidado completo com o corpo e a mente. Na nossa clínica, oferecemos tratamentos personalizados que valorizam a saúde da pele, promovem relaxamento e elevam a autoestima. Cada atendimento é pensado para proporcionar bem-estar, harmonizando resultados visíveis com conforto e cuidado. Aqui, cada pessoa encontra momentos de cuidado, equilíbrio e renovação.
                    </p>
                </div>
